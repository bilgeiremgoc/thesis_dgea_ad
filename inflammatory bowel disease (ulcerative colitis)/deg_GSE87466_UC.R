...
gse1em <- getGEO("GSE87466", GSEMatrix = TRUE, AnnotGPL = TRUE)
...
write_xlsx(deg, "deg_GSE87466_UC.xlsx")
...
write_xlsx(up_genes, "deg_GSE87466_UC_up_genes.xlsx")
write_xlsx(down_genes, "deg_GSE87466_UC_down_genes.xlsx")
...
write_xlsx(as.data.frame(go_result_BP), "deg_GSE87466_UC_GO_BP_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_MF), "deg_GSE87466_UC_GO_MF_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_CC), "GSE87466_UC_GO_CC_enrichment.xlsx")
...
write_xlsx(as.data.frame(kegg_enrich), "deg_GSE87466_UC_KEGG_enrichment.xlsx")
...
write_xlsx(as.data.frame(reactome_enrich), "deg_GSE87466_UC_reactome_enrichment.xlsx")
...
pheatmap(xcell_result, 
         main = "xCell Immune Infiltration - GSE87466",
         scale = "row",
         clustering_distance_rows = "euclidean",
         clustering_distance_cols = "euclidean")

write_xlsx(xcell_df, "deg_GSE87466_UC_xCell_Results.xlsx")
...
write_xlsx(stat_tests, "deg_GSE87466_UC_xcell_stat_tests.xlsx")
...
ggplot(long_xcell, aes(x = group, y = proportion, fill = group)) +
  ...
  theme_minimal() +
  labs(title = "Immune Cell Infiltration (xCell) - GSE87466") +
