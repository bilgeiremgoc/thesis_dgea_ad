...
write_xlsx(up_genes, "deg_GSE1919_RA_up_genes.xlsx")
write_xlsx(down_genes, "deg_GSE1919_RA_down_genes.xlsx")
...
write_xlsx(as.data.frame(go_result_BP), "deg_GSE1919_RA_GO_BP_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_MF), "deg_GSE1919_RA_GO_MF_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_CC), "deg_GSE1919_RA_GO_CC_enrichment.xlsx")
...
#xCell İnfiltrasyonu
gene_symbols <- getSYMBOL(rownames(exprs_data), "hgu95av2.db")
...
pheatmap(xcell_result, 
         main = "xCell Immune Infiltration - GSE1919",
         scale = "row",
         clustering_distance_rows = "euclidean",
         clustering_distance_cols = "euclidean")

write_xlsx(xcell_df, "deg_GSE1919_RA_SLE_xCell_Results.xlsx")
...
write_xlsx(stat_tests, "deg_GSE1919_RA_xcell_stat_tests.xlsx")
...
ggplot(long_xcell, aes(x = group, y = proportion, fill = group)) +
  ...
  theme_minimal() +
  labs(title = "Immune Cell Infiltration (xCell) - GSE1919") +
