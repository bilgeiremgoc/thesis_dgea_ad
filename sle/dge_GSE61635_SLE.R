...
write_xlsx(up_genes, "deg_GSE61635_up_genes.xlsx")
write_xlsx(down_genes, "deg_GSE61635_down_genes.xlsx")
...
write_xlsx(as.data.frame(go_result_BP), "deg_GSE61635_GO_BP_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_MF), "deg_GSE61635_GO_MF_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_CC), "deg_GSE61635_GO_CC_enrichment.xlsx")
...
write_xlsx(xcell_df, "deg_GSE61635_SLE_xCell_Results.xlsx")
